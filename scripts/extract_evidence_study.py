...
comparing PEER against baselines on a stratified sample of test cases.
Writes offline_eval_labeled.csv (method names visible), blind_study.csv
(method identity replaced with a randomized A/B/C option label, safe for
raters), and blind_study_mapping.csv (the decode key, NOT for raters)."""
