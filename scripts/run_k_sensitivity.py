...
def main():
    ...
    args = ap.parse_args()
    run([sys.executable, 'scripts/run_baselines.py', '--pairs-dir', args.pairs_dir, '--split', 'test', '--methods', 'sbert_user', 'bm25_user', '--k-list', *args.k_list, '--embeddings', args.embeddings, '--output', args.output_dir])
